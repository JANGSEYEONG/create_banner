...
const ColorPicker: React.FC<ColorPickerProps> = ({name, color, handleColorChange}) => {
      ...
      <div className={styles.container}>
        ...
        <div className={styles.item}>
          <CirclePicker
            ...
            color={color}
            circleSize={40}
            onChange={color => handleColorChange(color.hex)}></CirclePicker>
        </div>
        <div className={styles.item}>
          <HuePicker
            height={'20px'}
            width={'500px'}
            color={color}
            onChange={color => handleColorChange(color.hex)}></HuePicker>
        </div>
